package com.xiujing.ysf.modular.code.factory;


import com.xiujing.ysf.YsfApplication;
import com.xiujing.ysf.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("xiujing");
        genQo.setProjectPackage(YsfApplication.class.getPackage().getName());
