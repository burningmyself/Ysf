package com.xiujing.ysf.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.xiujing.ysf.core.config.properties.DruidProperties;
import com.xiujing.ysf.core.config.properties.MutiDataSourceProperties;
import com.xiujing.ysf.core.datascope.DataScopeInterceptor;
import com.xiujing.ysf.core.mutidatasource.DynamicDataSource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "ysf.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.xiujing.ysf.modular.*.dao","com.xiujing.ysf.multi.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "ysf.muti-datasource")
    ...
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        DruidDataSource dataSourceYsf = dataSource(druidProperties);
        ...
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[0], dataSourceYsf);
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[1], bizDataSource);
        dynamicDataSource.setTargetDataSources(hashMap);
        dynamicDataSource.setDefaultTargetDataSource(dataSourceYsf);
