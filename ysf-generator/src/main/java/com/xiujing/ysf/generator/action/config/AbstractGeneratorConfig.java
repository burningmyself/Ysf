...
import com.xiujing.ysf.core.util.FileUtil;
import com.xiujing.ysf.generator.engine.SimpleTemplateEngine;
import com.xiujing.ysf.generator.engine.base.YsfTemplateEngine;
import com.xiujing.ysf.generator.engine.config.ContextConfig;
import com.xiujing.ysf.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doYsfGeneration() {
        YsfTemplateEngine YsfTemplateEngine = new SimpleTemplateEngine();
        YsfTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        YsfTemplateEngine.setSqlConfig(sqlConfig);
        YsfTemplateEngine.setTableInfo(tableInfo);
        YsfTemplateEngine.start();
    }
}
