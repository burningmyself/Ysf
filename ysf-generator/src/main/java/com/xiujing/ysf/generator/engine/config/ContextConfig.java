package com.xiujing.ysf.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "ysfTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\ysf";//模板输出的项目目录
    ...
    private String proPackage = "com.xiujing.ysf.admin";
    private String coreBasePackage = "com.xiujing.ysf.core";
    private String modelPackageName = "com.xiujing.ysf.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.xiujing.ysf.modular.system.dao";    //model的dao
